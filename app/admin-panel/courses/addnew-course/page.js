...
const Coursepage = () => {
    ...
    return (
        <div style={{ width: "100%", maxWidth: "1100px", margin: "auto" }}>
            <h1 className="w-full my-10 text-lg font-bold flex items-center gap-2"><SiBookstack size={30} />Add Course</h1>
                ...
                <form className="flex flex-col gap-2 m-2  flex-wrap">
                    <div className='flex w-full items-center gap-5 flex-wrap '>
                        <div className='flex flex-col w-5/12'>
                            ...
                            <input type="text" id="course-name" placeholder="Enter Course Name" className="my-2 p-2 px-4 rounded   border" /></div>
                        <div className='flex flex-col w-5/12'>
                            <label htmlFor="course-slug">Course Slug: </label>
                            <input type="text" id="course-slug" placeholder="Enter Course Slug" className="my-2 p-2 rounded px-4   border" /></div>
                    </div>
                    ...
                    <textarea type="text" id="course-description" placeholder="Enter Course Description" className="my-2 p-2 px-4 rounded  w-10/12 border" rows={5} />
                    ...
                    <div className='flex   w-full  items-center gap-5 flex-wrap'>
                        <div className='flex flex-col '>
                            ...
                            <input type="number" id="course-fee" className="my-2 py-2 px-4 rounded  border" />

                        </div>
                        <div className='flex flex-col  '>
                            <label htmlFor='admission' >Admission:<span className='text-danger'>*</span></label>
                            <select id='admission' className="my-2 py-2 px-4 rounded  border"  >
                    ...
                    <div className='flex   w-full  items-center gap-5 flex-wrap'>
                        <div className='flex flex-col col-10 col-md-10 col-lg-5'>
                            ...
                            <select id='lecturing-modality' className="my-2 py-2 px-4  rounded border  w-full"  >
                                <option>--Select--</option>
                        ...
                        <div className='flex flex-col '>
                            ...
                            <input type='number' id='lectures' placeholder="Enter No. of Lectures" className="my-2 py-2 px-4 rounded  border" />
                        </div>
                    </div>
                    <div className='flex w-full  items-center gap-5 flex-wrap'>
                        <div className='flex flex-col '>
                            ...
                            <select id='course-level' className="my-2 py-2 px-4   border rounded w-full"  >
                                <option>--Select--</option>
                                <option>Basic</option>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input type='number' id='available-seats' placeholder='Enter Total Seats' className="my-2 py-2 px-4 rounded  border" />
                        </div>
                    </div>
                        <div className='my-5'>
