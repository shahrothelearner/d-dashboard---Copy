...
const EventUpdatePage = ({params}) => {
  ...
  useEffect(() => {
    ...
    const dataForUpdate = eventData.find(key => key._id == params.event)
  return (
        ...
        <form className="flex flex-col w-[90%] gap-2 m-6" >
          <div className="flex flex-row flex-wrap w-full justify-between">
            <div className='flex flex-col w-[48%]'>
              ...
              <input defaultValue={dataForUpdate.title} type="text" id="course-name" placeholder="Enter Event Name" className="my-2 p-2 border rounded" />
            </div>
            <div className='flex flex-col w-[48%] '>
              <label htmlFor="course-slug">Event Slug: </label>
              <input defaultValue={dataForUpdate.title} type="text" id="course-slug" placeholder="Enter Event Slug" className="my-2 p-2 border rounded" />
            </div>
          </div>
          ...
          <textarea type="text" id="course-description" placeholder="Enter Event Description" className="my-2 p-2 px-4 border rounded" rows={5} defaultValue={dataForUpdate.description}/>
          <label htmlFor="course-syllabus">Event Syllabus:</label>
          <textarea type="text" id="course-syllabus" placeholder="Enter Event Syllabus" className="my-2 p-2 px-4 border rounded" rows={5} defaultValue={dataForUpdate.syllabus}/>
          <label htmlFor="course-learn">What will you learn?: </label>
          <textarea type="text" id="course-learn" placeholder="Enter Event Learning" className="my-2 p-2 px-4 border rounded" rows={5} defaultValue={dataForUpdate.learning}/>
          <div className='flex flex-row w-full items-center gap-5 flex-wrap'>
            <div className='flex flex-col'>
              ...
              <input defaultValue={dataForUpdate.fee} type="number" id="course-fee" className="my-2 p-2 px-4 border rounded" />
            </div>
            <div className='flex flex-col '>
              <label htmlFor="course-name">Location:<span className='text-danger'>*</span> </label>
              <input defaultValue={dataForUpdate.location} type="text" id="course-name" placeholder="Enter Location" className="my-2 p-2 px-4 border rounded" />
            </div>
            <div className='flex flex-col '>
              <label htmlFor='duration'>Duration:<span className='text-danger'>*</span></label>
              <input defaultValue={dataForUpdate.duration} type='number' id='duration' placeholder="Enter duration" className="my-2 p-2 px-4  border rounded" />
            </div>
          </div>
          <div className='flex w-full items-center gap-5 flex-wrap'>
            ...
            >
              <input defaultValue={dataForUpdate.registration}
                type="text"
            ...
            <div
              ...
              data-te-input-wrapper-init
            >
              <input defaultValue={dataForUpdate.orientation}
                type="text"
                className="peer block min-h-[auto] w-full rounded border rounded-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          ...
          <div className='flex flex-row w-full items-center gap-5 flex-wrap '>
            ...
            <div
              ...
              data-te-input-wrapper-init
            >
              <input defaultValue={dataForUpdate.startTime}
                type="text"
                className="peer block min-h-[auto] w-full rounded border rounded-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                id="htmlForm2" />
              <label
            ...
            <div
              ...
              data-te-timepicker-init
              data-te-input-wrapper-init>
              <input defaultValue={dataForUpdate.endTime}
                type="text"
                className="peer block min-h-[auto] w-full rounded border rounded-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                id="htmlForm2" />
              <label
