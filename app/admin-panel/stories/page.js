...
const heading = {
    ...
    to: "/admin-panel/stories/addnew-story",
  }
...
const CoursePage = () => {
    ...
    return (
      <div>
        ...
        <DashboarDataTable data={CoursesData} dataArr={dataArr} setDataArr={setDataArr} dataStructure={dataStructure} tableStats={tableStats} sortBy={sortBy} updateLink="/admin-panel/stories/"/>
      </div>
    )
