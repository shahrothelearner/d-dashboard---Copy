...
const Coursepage = () => {
    ...
    return (
        <div style={{ width: "100%", maxWidth: "1100px", margin: "auto", minHeight:"100vh" }}>
            <h1 className="w-full my-10 text-lg font-bold flex items-center gap-2"><BiSolidVideos size={30} />Add Story</h1>
                ...
                <form className="flex flex-col gap-2 m-2  flex-wrap">
                    <div className='flex w-full items-center gap-5 flex-wrap '>
                        <div className='flex flex-col w-5/12'>
                            ...
                            <input type="text" id="story-title" placeholder="Enter Course Name" className="my-2 p-2 px-4 rounded   border" /></div>
                        <div className='flex flex-col w-5/12'>
                            <label htmlFor="story-url">Url: </label>
                            <input type="text" id="story-url" placeholder="Enter Course Slug" className="my-2 p-2 rounded px-4   border" /></div>
                    </div>
